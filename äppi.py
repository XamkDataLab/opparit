...
df2 = get_toimeksiantaja_oppilaitos()
...
df4 = df[~df['toimeksiantaja'].isin(poistettavat_arvot)]


df5 = get_oppilaitos_ta()
df['on_amk'] = df['toimeksiantaja'].str.contains('AMK|ammattikorkea', case=False, na=False)
